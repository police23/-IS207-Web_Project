 ...
 <main>
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="category-carousel container">
        <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Phân loại</h2>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                ...
                <div class="text-center">
                  <a href="shop.html" class="menu-link fw-medium">Apple</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_2.png') }} " width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="shop.html" class="menu-link fw-medium">Samsung</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_3.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="shop.html" class="menu-link fw-medium">OPPO</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_4.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="shop.html" class="menu-link fw-medium">Xiaomi</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_5.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="shop.html" class="menu-link fw-medium">Nokia</a>
                </div>
              </div>
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/home/demo3/category_6.png') }}" width="124"
                  height="124" alt="" />
                <div class="text-center">
                  <a href="shop.html" class="menu-link fw-medium">Realme</a>
                </div>
              </div>
            </div><!-- /.swiper-wrapper -->
      ...
      <section class="hot-deals container">
        <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Ưu đãi</h2>
        <div class="row">
          <div
            ...
            <a href="shop.html" class="btn-link default-underline text-uppercase fw-medium mt-3">Xem thêm</a>
          </div>
              ...
              <div class="swiper-container js-swiper-slider" data-settings='{
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/product-0-1.jpg') }}" width="258" height="313"
                          alt="iPhone 16 Pro Max" class="pc__img">
                      </a>
                    </div>
                    ...
                    <div class="pc__info position-relative">
                      ...
                      <div
                        ...
                        <button class="btn-link btn-link_lg me-4 text-uppercase fw-medium js-quick-view"
                          data-bs-toggle="modal" data-bs-target="#quickView" title="Xem chi tiết">
                          <span class="d-none d-xxl-block">Xem chi tiết</span>
                    ...
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/product-1-1.jpg') }}" width="258" height="313"
                          alt="Samsung Galaxy M55 5G" class="pc__img">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Samsung Galaxy M55 5G</a></h6>
                      <div class="product-card__price d-flex align-items-center">
                        <span class="money price-old">11.690.000đ</span>
                        <span class="money price text-secondary">9.390.000đ</span>
                      </div>
                    ...
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/product-2-1.jpg') }}" width="258" height="313"
                          alt="Xiaomi Redmi Note 13" class="pc__img">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Xiaomi Redmi Note 13</a></h6>
                      <div class="product-card__price d-flex align-items-center">
                        <span class="money price-old">4.890.000đ</span>
                        <span class="money price text-secondary">4.090.000đ</span>
                      </div>
                    ...
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/product-3-1.jpg') }}" width="258" height="313"
                          alt="OPPO Reno12 F 5G" class="pc__img">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">OPPO Reno12 F 5G</a></h6>
                      <div class="product-card__price d-flex align-items-center">
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/product-4-1.jpg') }}" width="258" height="313"
                          alt="Samsung Galaxy A35 5G" class="pc__img">
                      </a>
                    </div>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/product-5-1.jpg') }}" width="258" height="313"
                          alt="Samsung Galaxy A15" class="pc__img">
                      </a>
                    </div>

                    <div class="pc__info position-relative">
                      <h6 class="pc__title"><a href="details.html">Samsung Galaxy A15</a></h6>
                      <div class="product-card__price d-flex align-items-center">
                        <span class="money price-old">4.990.000đ</span>
                        <span class="money price text-secondary">4.350.000đ</span>
                      </div>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="details.html">
                        <img loading="lazy" src="{{ asset('assets/images/home/demo3/product-6-1.jpg') }}" width="258" height="313"
                          alt="iPhone 15 Pro Max" class="pc__img">
                      </a>
                    </div>
      ...
      <section class="products-grid container">
        ...
        <div class="row">
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="details.html">Samsung Galaxy S24 FE 5G</a></h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">16.990.000đ</span>
                </div>
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="details.html">iPhone 16 Pro</a></h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price-old">28.990.000đ</span>
                  <span class="money price text-secondary">26.990.000đ</span>
                </div>
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title">Samsung Galaxy Z Fold6 5G</h6>
                <div class="product-card__price d-flex align-items-center">
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title">iPhone 16 Plus</h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price-old">25.990.000đ</span>
                  <span class="money price text-secondary">25.590.000đ</span>
                </div>
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="details.html">OPPO A3 6GB</a></h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">4.990.000đ</span>
                </div>
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                <h6 class="pc__title"><a href="details.html">Samsung Galaxy A06 4GB</a></h6>
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price-old">3.490.000đ</span>
                  <span class="money price text-secondary">3.190.000đ</span>
                </div>
        ...
        <div class="text-center mt-2">
          <a class="btn-link btn-link_lg default-underline text-uppercase fw-medium" href="shop.html">Xem thêm</a>
        </div>
      </section>
    </div>
