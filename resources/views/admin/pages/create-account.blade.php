...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="{{asset('public/frontend/admin/css/dashboard.css')}}">
    <link rel="stylesheet" href="asset('public/frontend/admin/css/tailwind.css')" />
    <script
      src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js"
      defer
    ></script>
    <script src="{{asset('public/frontend/admin/js/innit-alpine.js') }}"></script>
  </head>
  <body>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="{{asset('public/frontend/images/create-account-office.jpeg') }}"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="{{asset('public/frontend/images/create-account-office-dark.jpeg') }}"
              alt="Office"
            />
          </div>
